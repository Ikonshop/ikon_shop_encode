...
function Dashboard() {
  ...
  // useEffect(() => {
  //   if (!connected ? renderConnectWallet() : null);
  // }, [publicKey]);
  ...
  return (
    <div className={styles.parent_container}>
      ...
      <div className={styles.main_container}>
        {!publicKey ? renderConnectWallet() : null}

        {publicKey && loading ? renderLoading() : null}
        
        {!loading && !showUserOrders && !showCreateLink && !showLinkOrders && !showElusivSetup
          ? renderDisplay()
          : null}
        {/* {publicKey && refreshLinks()} */}
        
        {publicKey && showUserOrders && renderUserOrdersComponent()}
        {publicKey && showCreateLink && renderCreateLinkComponent()}
        {publicKey && showLinkOrders && renderOrdersComponent()}
